...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { co_producto: @producto.co_producto, co_tipoproducto: @producto.co_tipoproducto, no_producto: @producto.no_producto, qt_stock: @producto.qt_stock, ss_precio: @producto.ss_precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { co_producto: @producto.co_producto, co_tipoproducto: @producto.co_tipoproducto, no_producto: @producto.no_producto, qt_stock: @producto.qt_stock, ss_precio: @producto.ss_precio } }
