...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { co_cliente: @reserva.co_cliente, co_reserva: @reserva.co_reserva, co_sala: @reserva.co_sala, fe_reserva: @reserva.fe_reserva, tx_descripcion: @reserva.tx_descripcion } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { co_cliente: @reserva.co_cliente, co_reserva: @reserva.co_reserva, co_sala: @reserva.co_sala, fe_reserva: @reserva.fe_reserva, tx_descripcion: @reserva.tx_descripcion } }
