...
class LocalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post locals_url, params: { local: { co_local: @local.co_local, correo: @local.correo, direccion: @local.direccion, no_local: @local.no_local, telefono: @local.telefono } }
    end
  ...
  test "should update local" do
    patch local_url(@local), params: { local: { co_local: @local.co_local, correo: @local.correo, direccion: @local.direccion, no_local: @local.no_local, telefono: @local.telefono } }
